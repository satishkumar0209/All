...
public class own {
	...
	// satish 192.168.1.64
	 ...
	 String nodeURL = "http://192.168.1.64:5555/wd/hub";//gaurav
	...
	public void setup() throws MalformedURLException, InterruptedException {
		...
		driver.get(baseURL);
		driver.findElement(By.xpath("(//*[@formcontrolname='username'])[1]")).sendKeys("neha1521");
		driver.findElement(By.xpath("(//*[@formcontrolname='password'])[1]")).sendKeys("password123");
