...
//	System.out.println(element);
	...
	for (int img = 1; img <= 10; img++) {
		...
		driver.findElement(By.xpath("//*[@class='ng-untouched ng-pristine ui-inputtext ui-corner-all ui-state-default ui-widget ng-valid']")).sendKeys("10.6");
