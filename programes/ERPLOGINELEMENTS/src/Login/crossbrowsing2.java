...
//	
	driver.findElement(By.xpath("(.//*[@class='ui-inputtext ui-widget ui-state-default ui-corner-all'])[4]")).sendKeys("s");
	
	driver.findElement(By.xpath(".//*[text()='Somnologist']")).click();
...
String original1 = driver.findElement(By.xpath("(.//*[@class='ui-progressbar-label'])[4]")).getText();
driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	String newString1 = original.replace("%","");
	
	int value4=Integer.parseInt(newString1);
	
	if(value4 == 50)
		System.out.println("percentage Equal");
	else
		System.out.println("False");
